...
public class DlgDonut extends JDialog {
	...
	public DlgDonut() {
		...
		{
			JLabel lblDonut = new JLabel("Center of Donut:");
			lblDonut.setFont(new Font("Century Schoolbook", Font.BOLD | Font.ITALIC, 11));
			GridBagConstraints gbc_lblNewLabelDonut = new GridBagConstraints();
			gbc_lblNewLabelDonut.insets = new Insets(0, 0, 5, 5);
			gbc_lblNewLabelDonut.gridx = 2;
			gbc_lblNewLabelDonut.gridy = 0;
			contentPanel.add(lblDonut, gbc_lblNewLabelDonut);
		}
		{
		...
		}
		{
			...
			GridBagConstraints gbc_lblNewLabelInnerRadius = new GridBagConstraints();
			gbc_lblNewLabelInnerRadius.insets = new Insets(0, 0, 5, 5);
			gbc_lblNewLabelInnerRadius.gridx = 2;
			gbc_lblNewLabelInnerRadius.gridy = 6;
			contentPanel.add(lblInnerRadius, gbc_lblNewLabelInnerRadius);
		}
		{
